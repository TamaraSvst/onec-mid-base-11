...
Процедура ДобавлениеКонтактноеЛицоНаФорму(Форма)
	...
	ПолеВводаВ = Форма.Элементы.Добавить("КонтактноеЛицо_ДЗ", Тип("ПолеФормы"), Форма.Элементы.ГруппаШапкаПраво);
	ПолеВводаВ.Вид = ВидПоляФормы.ПолеВвода;
	ПолеВводаВ.ПутьКДанным = "Объект.КонтактноеЛицо_ДЗ"; 
...
Процедура ДобавлениеПроцентСкидкиНаФорму(Форма)
	...
	ПолеВводаВ = Форма.Элементы.Добавить("ПроцентСкидки_ДЗ", Тип("ПолеФормы"), ГруппаСкидка);
	ПолеВводаВ.Вид = ВидПоляФормы.ПолеВвода;
	ПолеВводаВ.ПутьКДанным = "Объект.ПроцентСкидки_ДЗ"; 
